    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 px-4 py-8 sm:p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border-0 overflow-hidden">
          {/* Header */}
          <div className="text-center pt-8 pb-4 px-6 sm:px-8">
            ...
            <p className="text-sm sm:text-base text-gray-500 mt-2">Sign in to your Saviour account</p>
          </div>
          ...
          <div className="px-6 sm:px-8 pb-6">
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 sm:h-14 text-base border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-indigo-500"
                    value={email}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-12 h-12 sm:h-14 text-base border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-indigo-500"
                    value={password}
              ...
              <Button
                type="submit"
                className="w-full h-12 sm:h-14 text-base font-semibold bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white rounded-xl shadow-lg shadow-indigo-500/25 transition-all duration-200"
                disabled={loading || googleLoading}
              >
                {loading ? (
          ...
          {/* Footer */}
          <div className="px-6 sm:px-8 py-5 bg-gray-50/80 border-t border-gray-100">
