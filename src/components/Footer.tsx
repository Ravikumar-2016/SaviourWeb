          ...
          <div>
            ...
            <ul className="space-y-1">
              <li className="flex items-center">
                ...
                <a href="mailto:saviourglobalinfo@gmail.com" className="text-xs text-emerald-50 hover:text-white transition-colors">saviourglobalinfo@gmail.com</a>
              </li>
              <li className="flex items-center">
                <Phone size={14} className="mr-2 text-emerald-200" />
                <a href="tel:+9193xxxxxxxx" className="text-xs text-emerald-50 hover:text-white transition-colors">+91 93xxx xxxxx</a>
              </li>
            </ul>
          </div>
        </div>
