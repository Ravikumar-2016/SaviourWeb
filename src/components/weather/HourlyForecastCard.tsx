          ...
          <div className="flex gap-3 pb-2">
            {data.map((hour, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`min-w-[90px] flex flex-col items-center gap-2 p-3 rounded-2xl transition-all duration-200
                    ${isCurrent 
                ...
                >
                  ...
                  <span className={`text-lg font-bold ${isCurrent ? "text-primary" : ""}`}>
